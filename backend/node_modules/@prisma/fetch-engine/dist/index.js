...
__export(index_exports, {
  ...
  download: () => import_chunk_5YVCAGZ3.download,
  engineEnvVarMap: () => import_chunk_PXQVM7NP.engineEnvVarMap,
  getBinaryEnvVarPath: () => import_chunk_PXQVM7NP.getBinaryEnvVarPath,
  getBinaryName: () => import_chunk_5YVCAGZ3.getBinaryName,
  getCacheDir: () => import_chunk_YJOPKU47.getCacheDir,
  getProxyAgent: () => import_chunk_LOOX3H4O.getProxyAgent,
  getVersion: () => import_chunk_5YVCAGZ3.getVersion,
  maybeCopyToTmp: () => import_chunk_5YVCAGZ3.maybeCopyToTmp,
  overwriteFile: () => import_chunk_YJOPKU47.overwriteFile,
  plusX: () => import_chunk_5YVCAGZ3.plusX,
  vercelPkgPathRegex: () => import_chunk_5YVCAGZ3.vercelPkgPathRegex
});
module.exports = __toCommonJS(index_exports);
var import_chunk_5YVCAGZ3 = require("./chunk-5YVCAGZ3.js");
